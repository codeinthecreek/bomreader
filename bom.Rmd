...
### Download latest 72 hours of data from BoM for 1 or more locations
...
The following shows how to read a single JSON file (with the filename `fname`) that was downloaded from BoM in section [Single location download](#singledl), into a dataframe for analysis.
