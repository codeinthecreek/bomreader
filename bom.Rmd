...
### Show the (usually) hottest time of day per location
...
### Show the (usually) coldest time of day per location
...
### Graph hottest and coldest times of day
...
typical_tod_temp_by_loc <- summary_avt_by_tod %>%
  ...
  summarise(
    ...
    meantemp = round(mean(sum(morn, day, eve, night)/4), digits=1)
    ) %>%
  arrange(meantemp)
